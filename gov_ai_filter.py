...
- 보유 자격 (2026-09-13 시저님 보증 — 사업자등록증에 등재)
  · 장애인기업
  · 사회적기업
  · AI기업
  ※ 가점·우대·자격제한 공고를 판단할 때 위 셋을 가진 것으로 본다.
  ※ 유효기간은 확인되지 않았다. 기간을 묻는 공고는 "보류"로 두고 사람이 확인한다.
...
- "추천": 위 등록 종목 중 하나로 수행 가능한 지원사업. 구체적으로는
  ...
  · 복지용구: 노인복지용구·장애인보장구·고령친화·보조공학기기 유통 및 판로지원
  · 환경/공기질: 실내공기질 개선, 새집증후군 제거 등 실내환경 서비스
- "보류": 종목과 부분적으로 닿거나 대상·조건이 애매하지만 가능성 있는 공고
- "제외": 등록 종목 어느 것으로도 수행할 수 없는 공고(건설·공사·제조설비·농수산 생산 등),
  이미 마감·종료된 공고
- 사무용품·소모품 조달, 중증장애인생산품 우선구매처럼 물품 납품에 해당하는 건은
  이 파이프라인의 대상이 아니다("제외"). 나라장터 물품입찰 쪽에서 따로 다룬다.
