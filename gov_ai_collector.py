...
# 도소매업 — 노인복지용구·장애인보장구 / 자격 기반(장애인기업)
KW_DISABILITY = [
    "장애인기업", "장애인고용", "장애인표준사업장", "중증장애인생산품",
    "장애인보장구", "보조공학", "복지용구", "노인복지", "고령친화",
    "배리어프리", "무장애", "접근성",
]

# 자격 기반 — 사회적경제 (예비사회적기업 포함)
KW_SOCIAL = [
    "사회적기업", "예비사회적기업", "사회적경제", "소셜벤처",
    "마을기업", "자활기업", "협동조합",
]

# 서비스업 — 에어컨청소·새집증후군제거 (실내환경)
KW_ENV = [
    "실내공기질", "공기질", "새집증후군", "환경개선", "실내환경",
    "친환경", "환경서비스",
]

# 서비스업 — 행사대행·전시·컨벤션·축제 / 정보통신업 — 문화예술콘텐츠개발
KW_CULTURE = [
    "행사대행", "행사기획", "축제", "컨벤션", "전시", "문화공연",
    "문화예술", "콘텐츠", "공예", "굿즈", "지역축제",
]

# 판로·구매 — 위 종목의 매출로 이어지는 지원
KW_MARKET = [
    "우선구매", "공공구매", "판로", "판로개척", "마케팅지원",
]

AI_KEYWORDS = KW_AI + KW_DISABILITY + KW_SOCIAL + KW_ENV + KW_CULTURE + KW_MARKET
